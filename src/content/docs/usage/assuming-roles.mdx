...
[!] Granted works best with Firefox but also supports Chrome, Brave, and Edge (https://docs.granted.dev/introduction#supported-browsers). You can change this setting later by running 'granted browser set'
...
ℹ️ To assume roles with Granted, we need to add an alias to your shell profile (https://docs.granted.dev/internals/shell-alias).

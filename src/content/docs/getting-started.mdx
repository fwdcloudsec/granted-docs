...
<Tabs>
  <TabItem label="MacOS">
    ...
    ```bash
    curl -OL https://releases.granted.dev/granted/v0.36.2/granted_0.36.2_darwin_x86_64.tar.gz
    ...
    ```bash
    curl -OL https://releases.granted.dev/granted/v0.36.2/granted_0.36.2_darwin_arm64.tar.gz
  ...
  <TabItem label="Linux (Manual)">
    ...
    >
      ...
      <TabItem label="x86_64">
        ...
        ```bash
        curl -OL releases.granted.dev/granted/v0.36.2/granted_0.36.2_linux_x86_64.tar.gz
      ...
      <TabItem label="arm64">
        ...
        ```bash
        curl -OL releases.granted.dev/granted/v0.36.2/granted_0.36.2_linux_arm64.tar.gz
      ...
      <TabItem label="i386">
        ...
        ```bash
        curl -OL releases.granted.dev/granted/v0.36.2/granted_0.36.2_linux_i386.tar.gz
  ...
  <TabItem label="Windows">
    ...
    [Granted for Windows x86_64](https://releases.granted.dev/granted/v0.36.2/granted_0.36.2_windows_x86_64.zip)

    [Granted for Windows arm64](https://releases.granted.dev/granted/v0.36.2/granted_0.36.2_windows_arm64.zip)

    [Granted for Windows i386](https://releases.granted.dev/granted/v0.36.2/granted_0.36.2_windows_i386.zip)
